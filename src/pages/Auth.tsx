        ...
        <div className="space-y-2">
          ...
          >
            <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17.05 12.04c-.03-3 2.45-4.43 2.56-4.5-1.4-2.04-3.57-2.32-4.34-2.35-1.85-.19-3.61 1.09-4.55 1.09-.94 0-2.39-1.06-3.94-1.03-2.03.03-3.9 1.18-4.94 3-2.11 3.66-.54 9.07 1.51 12.04 1 1.45 2.2 3.08 3.77 3.02 1.51-.06 2.08-.98 3.91-.98 1.82 0 2.34.98 3.94.95 1.63-.03 2.66-1.48 3.66-2.94 1.15-1.68 1.62-3.31 1.65-3.4-.04-.02-3.17-1.22-3.2-4.84zM14.07 3.24c.83-1.01 1.39-2.41 1.23-3.81-1.2.05-2.65.8-3.51 1.8-.77.89-1.45 2.32-1.27 3.69 1.34.1 2.71-.68 3.55-1.68z"/>
            </svg>
            Continue with Apple
          </Button>
        </div>
        {isGoogleLoading && (
          <div className="flex justify-center"><Loader2 className="h-3.5 w-3.5 animate-spin text-muted-foreground" /></div>
        )}
